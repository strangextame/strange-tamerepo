...
public class CapacitorHttpUrlConnection implements ICapacitorHttpUrlConnection {
    ...
    public void setRequestBody(PluginCall call, JSValue body, String bodyType) throws JSONException, IOException {
        ...
        if (contentType.contains("application/json")) {
            ...
            byte[] decodedBytes = Base64.getDecoder().decode(body.toString());
            connection.setRequestProperty("Content-Length", String.valueOf(decodedBytes.length));
            writeRequestBody(decodedBytes);
    ...
    /**
     * Writes the provided byte array to the HTTP connection managed by this instance.
     * @param body The byte array to write to the connection stream.
     */
